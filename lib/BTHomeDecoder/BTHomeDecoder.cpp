...
//         int dataLen = getObjectDataLength(objID);
//         if (dataLen < 0) {
//             // Unknown object ID, skip this byte and continue
//             Serial.printf("Unknown objectID: 0x%02X, skipping\n", objID);
//             continue;
//         }
//         if (idx + dataLen > payload.size()) {
//             Serial.printf("Not enough bytes for objID: 0x%02X\n", objID);
//             break;
//         }

//         float factor = getObjectFactor(objID);
//         bool isSigned = (objID == 0x02); // Treat temperature as signed
//         float val = 0.0f;
//         if (isSigned) {
//             val = parseSignedLittle(&payload[idx], dataLen, factor);
//         } else {
...
// //         case 0x2E: // humidity (alt)
// //         case 0x2F: // soil moisture
// //             return 1;
// //         case 0x08: case 0x12: case 0x13: case 0x14:
// //         case 0x40: case 0x41: case 0x43: case 0x44: case 0x45: case 0x46:
// //         case 0x47: case 0x48: case 0x51: case 0x52: case 0x56: case 0x57:
// //         case 0x58: case 0x5E: case 0x5F:
// //             return 2;
